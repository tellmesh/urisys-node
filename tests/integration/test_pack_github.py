...
def test_github_wheel_url_stt():
    url = github_wheel_url("stt")
    assert url == "https://github.com/tellmesh/uristt/releases/download/v0.1.0/uristt-0.1.0-py3-none-any.whl"


def test_github_wheel_url_webrtc():
    url = github_wheel_url("webrtc")
    assert url == "https://github.com/tellmesh/uriwebrtc/releases/download/v0.1.0/uriwebrtc-0.1.0-py3-none-any.whl"
